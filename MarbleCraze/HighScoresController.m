...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i < [[self.highScores allKeys] count]; i++) {
        ...
        if (player.length == 0) {
            self.score2Edit = i;
            self.txtPlayer = [[UITextField alloc] initWithFrame:CGRectMake(60, 30+(i*30), 160, 25)];
            ...
            UILabel *lblPlayer = [[UILabel alloc] initWithFrame:CGRectMake(60, 30+(i*30), 160, 25)];
        ...
        UILabel *lblScore = [[UILabel alloc] initWithFrame:CGRectMake(220, 30+(i*30), 60, 25)];
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    UILabel *lblPlayer = [[UILabel alloc] initWithFrame:CGRectMake(textField.frame.origin.x, textField.frame.origin.y, 140, 25)];
    lblPlayer.backgroundColor = [UIColor clearColor];
    lblPlayer.textColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0];
    lblPlayer.shadowColor = [UIColor colorWithRed:0.6 green:0.0 blue:0.0 alpha:1.0];
    lblPlayer.shadowOffset = CGSizeMake(1, 1);
